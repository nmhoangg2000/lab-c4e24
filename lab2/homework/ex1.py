...
dl = YoutubeDL()
dl.download(['https://www.youtube.com/watch?v=iJKV5miglAg']) # Remember to put your video in a list, eventhough one video is downloaded
...
dl.download(['https://www.youtube.com/watch?v=wNVIn-QS4DE', 'https://www.youtube.com/watch?v=5R5YnEbp2CU'])
...
dl = YoutubeDL(options)
dl.download(['chariots paper route'])